-- ============================================
-- USER REPORTS CRUD SETUP
-- Complete database setup for user-specific report management
-- ============================================

-- ============================================
-- 1. FIX INCOMPLETE TRIGGER FUNCTION
-- ============================================
...
-- Drop the trigger if it exists and recreate it properly
DROP TRIGGER IF EXISTS handle_report_timestamps_trigger ON reports;

-- Wait a moment and create the trigger
CREATE TRIGGER handle_report_timestamps_trigger 
BEFORE INSERT OR UPDATE ON reports 
FOR EACH ROW 
EXECUTE FUNCTION handle_report_timestamps();
...
-- Verify the setup
SELECT 'User Reports CRUD setup completed successfully!' AS status;
